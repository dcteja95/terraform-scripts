...
module "athena" { source="./athena" name_prefix=var.name_prefix artifacts_bucket_name=var.artifacts_bucket_name database_name=module.glue.database_name tags=var.tags }
