...
resource "aws_glue_crawler" "curated" { name="${var.name_prefix}-curated-crawler" role=var.data_role_arn database_name=aws_glue_catalog_database.this.name table_prefix="bike_" s3_target { path="s3://${var.curated_bucket_name}/bike-sharing/" } }
